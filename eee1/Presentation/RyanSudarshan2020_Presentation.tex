...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item India is now the largest user of groundwater in the world
...
\begin{frame}
    ...
    \begin{itemize}
        \item Agriculture is ~16\% of India's GDP, but a huge portion of consumer surplus
        \item ~60\% of Indian population works in the agriculture sector
...
\begin{frame}
    ...
    {\footnotesize
    \begin{itemize}
        \item I think I have a hard time thinking about the exclusion restriction here because there are so many instruments, and they use a double lasso approach to pick the instruments. But generally I am thinking that the same selection behavior that would cause a farmer to choose a piece of land with low water depth would be the same selection behavior that would cause them to choose land with certain geological features
